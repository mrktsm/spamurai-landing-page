    ...
    <div className="bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-white font-inter min-h-screen">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <div className="flex items-center space-x-8">
                ...
                <a
                  href="#"
                  className="bg-gradient-to-r from-red-600 to-red-500 text-white font-medium py-2 px-4 rounded-full hover:opacity-90 transition-opacity"
                >
                  Get Started
                </a>
              </div>
      ...
      <header className="relative pt-32 pb-24 text-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <a
            href="#"
            className="bg-gradient-to-r from-red-600 to-red-500 text-white font-medium py-3 px-8 rounded-full text-lg hover:opacity-90 transition-opacity inline-block"
          >
